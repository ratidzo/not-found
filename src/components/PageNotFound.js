    ...
    return(
        ...
        >
            ...
            rounded-lg backdrop-blur">
                ...
                <p className="mt-6 sm:text-lg leading-7 text-gray-300 ">Sorry, we couldn't find the page you're looking for.</p>
                <div className="mt-10 flex items-center justify-center
                gap-x-2 sm:gap-x-6">
                    <a href="#"
                    className="rounded-md bg-teal-600 px-3.5 py-2.5 text-sm sm:text-lg
                    font-semibold text-white shadow-sm hover:bg-teal-500
                    focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ">
                        <span>&larr;</span> Go back home
                    </a>
                    <a href="#" 
                    className="text-sm sm:text-lg font-semibold text-gray-100
                    rounded-md hover:bg-gray-100/20 hover:backdrop-blur px-3.5 py-2.5">
